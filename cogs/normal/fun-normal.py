...
class Names(disnake.ui.Select):
    ...
    async def callback(self, interaction: disnake.MessageInteraction):
        ...
        if user_choice_index == 0:
            ...
            в свою очередь представляющего собой французский вариант древнегерманского имени Adalheid (Adelheid, Adelheidis). 
            Это сложное слово включает два корня: adal (благородный, знатный) и heid (вид, род, образ). Таким образом, имя Adalheid означает 
            не что иное, как «благородная видом», «благородная происхождением» или же просто «благородство». Такое же значение, с определённой 
            эмоциональной окраской, можно признать и за именем Алиса. Существуют гипотезы о связи имени Алиса с греческим женским именем Каллиста, 
            или с греческим же словом aletheia («истина»)."""
